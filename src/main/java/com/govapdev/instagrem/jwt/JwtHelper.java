package com.govapdev.instagrem.jwt;
...
import com.govapdev.instagrem.document.RefreshToken;
...
public class JwtHelper {
    ...
    public JwtHelper(@Value("${accessTokenSecret}") String accessTokenSecret, @Value("${refreshTokenSecret}") String refreshTokenSecret, @Value("${com.govapdev.instagrem.refreshTokenExpirationDays}") int refreshTokenExpirationDays, @Value("${com.govapdev.instagrem.accessTokenExpirationMinutes}") int accessTokenExpirationMinutes) {
